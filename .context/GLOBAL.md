...
- `.context/planning/011_VERSION_1_2_0_GUTENBERG_SUPERCHARGER_MOTION_PLANNING.md` — active `1.2.0` portable motion planning for `skvn-marine-blocks`. Plugin-owned motion must ship its own CSS/JS/keyframes/fallbacks and remain portable without the `skvn-marine` theme.
